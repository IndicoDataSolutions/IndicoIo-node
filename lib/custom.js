...
var Collection = function(collection, config) {
  ...
  this.addData = function(data) {
    _this.promise_chain = _this.promise_chain.then(function() {
      ...
      make_request('/custom/add_data', data, batch, _this.baseConfig).then(function (res) {
  ...
  this.removeExample = function(data) {
    _this.promise_chain = _this.promise_chain.then(function() {
      ...
      make_request('/custom/remove_example', data, batch, _this.baseConfig).then(function(res) {
        deferred.resolve(res);
      });
      return deferred.promise;
    });
  ...
  this.train = function() {
    _this.promise_chain = _this.promise_chain.then(function() {
      var deferred = Promise.pending();
      make_request('/custom/train', {}, false, _this.baseConfig).then(function(res) {
          deferred.resolve(res);
      });
      return deferred.promise;
    });
  ...
  this.predict = function(data) {
    _this.promise_chain = _this.promise_chain.then(function() {
      ...
      var deferred = Promise.pending();
      make_request('/custom/predict', data, batch, _this.baseConfig).then(function(res) {
        deferred.resolve(res);
      });
      return deferred.promise;
    });
  ...
  this.clear = function() {
    _this.promise_chain = _this.promise_chain.then(function() {
      ...
      make_request('/custom/clear_collection', {}, false, _this.baseConfig).then(function(res) {
          deferred.resolve(res);
      });
      return deferred.promise;
    });
